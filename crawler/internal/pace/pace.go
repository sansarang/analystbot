...
// 실제 시작 시각은 경기마다 다르고, NPB 가속은 시작 15분 전(17:45)에 끝낸다.
package pace
...
const (
	...
	// NPB 타순은 시작 약 1시간 전부터 뜬다. 크롤·분석은 시작 15분 전
	// (18:00 → 17:45)에 끝낸다. 그 뒤에 가속하면 17:45 종료선을 넘긴다.
	NPBLead       = 1 * time.Hour
	NPBStopBefore = 15 * time.Minute
)
