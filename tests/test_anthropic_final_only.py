...
_ALLOWED = {
    ...
    # [SRCH-2 2026-09-12 사용자 지시] **웹 검색.** "x seach 삭제....그자리에
    #   안트로픽 서치로" · "퍼플릭스와 안트로픽".
    #   🔴 **판정이 아니다.** 승패를 묻지 않는다 — 질문 3개에 답만 받아 오고,
    #      그 답은 수집 행이 되어 제미니에게 간다. 최종 판정은 제미니 1회다
    #      (SRCH-1 이 2차 검증을 지웠다).
    #   ⚠️ 기본 꺼짐(`WEBSEARCH_ENABLED`). 경기당 약 $0.102.
    "app/collectors/websearch.py",
}
