...
🔴 [MKT-3 2026-09-09] **한시가 아니라 상시다.** 재캘리브레이션이 끝났고 답은
   "끄지 마라"였다 — 게이트 통과분 6/21=28.6%(P=0.039) · 판정 AUC 0.5122 ·
   시장 AUC 0.6421 · 괴리 상위 20경기에서 판정 35% vs 시장 85%.
   아래 `test_switch_off_restores_previous_behaviour` 는 **스위치가 동작한다는
   것**을 검사할 뿐, 끄라는 뜻이 아니다.
"""
